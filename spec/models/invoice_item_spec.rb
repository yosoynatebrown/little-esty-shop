...
RSpec.describe InvoiceItem, type: :model do
  describe 'relationships' do
    ...
    before :each do
      ...
      @discount = create(:bulk_discount, merchant: @merchant, percent_discount: 0.15, quantity_threshold: 11)
      @discount = create(:bulk_discount, merchant: @merchant, percent_discount: 0.2, quantity_threshold: 12)
      @discount = create(:bulk_discount, merchant: @merchant, percent_discount: 0.3, quantity_threshold: 20)
